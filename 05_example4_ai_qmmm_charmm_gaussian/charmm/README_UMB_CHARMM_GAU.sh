...
conda activate knamsessionenv
 # if HPC, module load openmpi-5.0.5 # load the openmpi=5 module available on the remote machine

# Set Gaussian to path
export g16root=/usr/local/gaussian/g16c01_chem_dept
. $g16root/g16/bsd/g16.profile
# or if in HPC, module load gaussian/g09

# Generated by CHARMM-GUI (http://www.charmm-gui.org) v3.7
charmm="mpirun -np 12 /scratch/<user_name>/icomse_knam_session/charmm/install_charmm/bin/charmm" # replace <user_name> with your actual username 
